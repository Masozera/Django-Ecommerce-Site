"""
Django settings for zoddock project.
...
SECRET_KEY = 'h2ymg!-n=7r0c$#22yn9klfbqeaig()(kt)uapb$$-dh5sf=sq'
...
INSTALLED_APPS = [
    ...
    'zoddockapp.apps.ZoddockappConfig',
...
WSGI_APPLICATION = 'zoddock.wsgi.application'
